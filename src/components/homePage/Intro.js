...
export const Intro = () => {
  return (
    <div style={{ backgroundImage: `url(${frontpage})` }} className="h-screen bg-cover bg-no-repeat bg-center flex justify-center items-center">
      <div className="md:w-3/4 md:mx-20 min-w-fit md:h-2/4 h-fit p-6   border-white/[0.3] border-2 rounded-lg shadow bg-gray-800/[0.6] dark:border-gray-700 flex flex-col justify-center items-center content-center">
