...
export const Intro = () => {
  return (
    ...
    <div className="h-screen flex justify-center items-center">
      <div className="md:w-3/4 md:mx-20 min-w-fit md:h-2/4 h-fit p-6  mb-8  border-white/[0.1] border-2 rounded-2xl  bg-gray-800/[0.1]  flex flex-col justify-center items-center content-center">
