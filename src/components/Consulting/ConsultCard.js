...
export const ConsultCard = ({serviceLink,head,detail,card}) => {
  return (
    <div className=' rounded-2xl border-l border-r border-b md:border-t md:max-w-full w-full h-full md:mx-20  mb-2 md:flex'>  
          ...
          <div className="p-5 flex flex-col text-center items-center justify-center  rounded-b-2xl md:w-3/4">
              ...
              <p className="mb-3 md:h-36  text-sm text-gray-400 tracking-tight ">{detail}</p>
