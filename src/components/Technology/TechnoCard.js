...
export const TechnoCard = ({head,detail}) => {
  return (
    <div>
        
        <div className="max-w-sm bg-black border border-gray-200 rounded-lg flex flex-col justify-items-center items-center  shadow-xl shadow-rose-50 mb-8">
            <a href="/">
