  ...
  return (
    <div className='pt-20 text-white'>
        ...
        <div className='flex md:flex-row flex-col md:w-full px-10  sm:px-28 md:px-2 gap-3 md:flex-wrap justify-center'>
          ...
          <ConsultCard serviceLink="/a" card={test} head="Software Testing" detail="Our testing service ensures that your software performs reliably,meeting industry standards."/>
          ...
          <ConsultCard serviceLink="/a" card={softMain} head="Software Maintenance" detail="We provide support and maintenance service to ensure that your software runs smoothly."/>
